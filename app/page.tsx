  ...
  return (
    <div className="bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <Link href="/auth/login">
              <Button variant="ghost" className="text-slate-700 hover:text-slate-900 px-3 sm:px-4">
                Sign In
              </Button>
            </Link>
            <Link href="/auth/signup">
              <Button className="bg-green-600 hover:bg-green-700 text-white px-3 sm:px-4">
                Get Started
              </Button>
            </Link>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24 text-center">
        ...
        <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold text-slate-900 mb-6 text-balance leading-tight">
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          <Link href="/auth/signup">
            <Button size="lg" className="bg-green-600 hover:bg-green-700 text-white h-12 px-6 sm:px-8 text-base">
              Start Trading <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
          </Link>
          <Link href="/auth/login">
            <Button size="lg" variant="outline" className="h-12 px-6 sm:px-8 text-base border-slate-300">
              View Marketplace
            </Button>
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          {[
            ...
            return (
              <div
                key={feature.title}
                className="p-6 sm:p-8 bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all"
              >
      ...
      {/* For Collectors */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20 border-t border-slate-200">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12 items-center">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8 h-64 sm:h-80 flex items-center justify-center border border-green-200">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20 border-t border-slate-200">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12 items-center">
          <div className="order-2 md:order-1 bg-gradient-to-br from-emerald-50 to-teal-100 rounded-2xl p-8 h-64 sm:h-80 flex items-center justify-center border border-teal-200">
            <div className="text-center">
            ...
            {[
              ...
              return (
                <div key={stat.label}>
                  ...
                  <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 mb-1">{stat.value}</p>
